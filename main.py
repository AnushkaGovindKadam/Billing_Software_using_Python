...
#         bg_color = "#887ff0"
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#887ff0")
        F1.place(x=0, y=80, relwidth=1)

        cname_lbl = Label(F1, text="Customer Name:", bg="#887ff0", font=('times new roman', 15, 'bold'))
        cname_lbl.grid(row=0, column=0, padx=20, pady=5)
        cname_txt = Entry(F1, width=15, textvariable=self.c_name, font='arial 15', bd=7, relief=GROOVE)
        cname_txt.grid(row=0, column=1, pady=5, padx=10)

        cphn_lbl = Label(F1, text="Customer Phone:", bg="#887ff0", font=('times new roman', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="#887ff0", font=('times new roman', 15, 'bold'))
        ...
        bil_btn = Button(F1, text="Search", command=self.find_bill,bg="#070791",fg="white" ,width=10, bd=7, font=('arial', 12, 'bold'), relief=GROOVE)
        bil_btn.grid(row=0, column=6, pady=5, padx=10)
        
        
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#887ff0")
        F2.place(x=5, y=180, width=325, height=380)

        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        syrup_lbl = Label(F2, text="Syrup", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        cream_lbl = Label(F2, text="Cream", font=('times new roman', 16, 'bold'), bg = "#887ff0", fg = "black")
        ...
        thermal_gun_lbl = Label(F2, text="Tablets", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#fcb1de")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#fcb1de", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="#fcb1de", fg="black")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#fcb1de", fg="black")
        ...
        spices_lbl = Label(F3, text="Spices", font=('times new roman', 16, 'bold'), bg="#fcb1de", fg="black")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#fcb1de", fg="black")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#fcb1de", fg="black")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#887ff0")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        mineral_lbl = Label(F4, text="Mineral Water", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        juice_lbl = Label(F4, text="Juice", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        lassi_lbl = Label(F4, text="Lassi", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Fruity", font=('times new roman', 16, 'bold'), bg="#887ff0", fg="black")
    ...
    # =================BillArea======================
        ...
        bill_title = Label(F5, text="Bill Area", font='arial 15 bold',bg="#fcb1de", bd=7, relief=GROOVE)
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('times new roman', 14, 'bold'), bd=10, fg="Black", bg="#fcb1de")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'), bg="#fcb1de", fg="black")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#fcb1de", fg="black")
        ...
        m3_lbl = Label(F6, text="Total Cold Drinks Price", font=('times new roman', 14, 'bold'), bg="#fcb1de", fg="black")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#fcb1de", fg="black")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#fcb1de", fg="black")
        ...
        m6_lbl = Label(F6, text="Cold Drinks Tax", font=('times new roman', 14, 'bold'), bg="#fcb1de", fg="black")
    ...
    # =======Buttons-======================================
        btn_f = Frame(F6, bd=7,bg="#fafafc" ,relief=GROOVE)
        btn_f.place(x=760, width=580, height=105)

        total_btn = Button(btn_f, command=self.total, text="Total", bg="#070791", bd=2, fg="white", pady=15, width=12, font='arial 13 bold')
        total_btn.grid(row=0, column=0, padx=5, pady=5)

        generateBill_btn = Button(btn_f, command=self.bill_area, text="Generate Bill", bd=2, bg="#070791", fg="white", pady=12, width=12, font='arial 13 bold')
        generateBill_btn.grid(row=0, column=1, padx=5, pady=5)

        clear_btn = Button(btn_f, command=self.clear_data, text="Clear", bg="#070791", bd=2, fg="white", pady=15, width=12, font='arial 13 bold')
        clear_btn.grid(row=0, column=2, padx=5, pady=5)

        exit_btn = Button(btn_f, command=self.exit_app, text="Exit", bd=2, bg="#070791", fg="white", pady=15, width=12, font='arial 13 bold')
